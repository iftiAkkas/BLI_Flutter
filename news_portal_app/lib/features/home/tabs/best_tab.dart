...
class BestStoriesTab extends StatefulWidget {
  const BestStoriesTab({super.key});

  @override
  State<BestStoriesTab> createState() => _BestStoriesTabState();
}

class _BestStoriesTabState extends State<BestStoriesTab> {
  ...
  Future<List<Story>> loadStories() async {
    final ids = await api.fetchStoryIds('beststories');
