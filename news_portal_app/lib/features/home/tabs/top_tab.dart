...
class TopStoriesTab extends StatefulWidget {
  const TopStoriesTab({super.key});

  @override
  State<TopStoriesTab> createState() => _TopStoriesTabState();
}

class _TopStoriesTabState extends State<TopStoriesTab> {
  ...
  Future<List<Story>> loadStories() async {
    final ids = await api.fetchStoryIds('topstories');
